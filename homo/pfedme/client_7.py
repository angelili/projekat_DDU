...
def main() -> None:
    ...
    if Benchmark==True:
      ...
      data = torch.load('/home/s124m21/projekat_DDU/homo/fedavg/data_7.pt')
      # Retrieve the variables
      trainloader = data['trainloader']
      testloader = data['testloader']
    else:
       # Make new variables
      data = torch.load('/home/s124m21/projekat_DDU/homo/pfedme/data_7.pt')
      # Retrieve the variables
      trainloader = data['trainloader']
      testloader = data['testloader']
    ...
    # Start client
    client_7 = client.MnistClient(model, trainloader, testloader, DEVICE)
