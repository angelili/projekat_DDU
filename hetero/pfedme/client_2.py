...
def load_data() -> (
    ...
    selected_classes = [1, 2, 3, 4, 5]  # Replace with your selected classes
...
class MnistClient(fl.client.NumPyClient):
    """Flower client implementing FashionMNISTimage classification using
    PyTorch."""
...
def main() -> None:
    ...
    # Load data
    if Benchmark==True:
        data = torch.load('/home/s124m21/projekat_DDU/hetero/fedavg/data_2.pth')
